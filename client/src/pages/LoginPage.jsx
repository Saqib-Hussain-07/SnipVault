    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ color: '#4b5563', fontSize: 13, marginTop: 4 }}>Your personal code snippet library</p>
        </div>

        <div style={{ background: '#13151f', border: '1px solid #1e2235', borderRadius: 16, padding: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, color: '#e2e8f0', margin: '0 0 20px' }}>Sign in</h2>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input type="password" value={form.password} onChange={set('password')} placeholder="••••••••" style={inputStyle} required />
            </div>
